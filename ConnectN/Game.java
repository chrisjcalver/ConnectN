...
//This is the main class. It's roll is to initialise all the other game objects then keep track of the turn and 

// call on the right player for a move. It's also responsible for checking for a wine or a draw after each turn,
